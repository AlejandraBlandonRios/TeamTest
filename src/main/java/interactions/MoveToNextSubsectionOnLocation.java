...
public class MoveToNextSubsectionOnLocation implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        WebElement nextElement = chromeBrowser.findElement(By.xpath("/html/body/div[1]/div/section[4]/div/div/div[2]/div/div[3]/img[2]"));
        Actions actions = new Actions(chromeBrowser);
        actions.moveToElement(nextElement);
        actions.doubleClick();
        actions.clickAndHold(nextElement).moveByOffset(50,50).release().build().perform();
    }
